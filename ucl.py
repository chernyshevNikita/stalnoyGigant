...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label_city = QtWidgets.QLabel(self.groupBox)
        ...
        self.horizontalLayout_3.addWidget(self.lineEdit_city)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.groupBox.setTitle(_translate("Dialog", "Изменение покупателя"))
